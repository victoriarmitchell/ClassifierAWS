...
class ListParameterAttributes(CommonStringParameterAttributes):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ListParameterAttributes.__init__)
            check_type(argname="argument parameter_name", value=parameter_name, expected_type=type_hints["parameter_name"])
            check_type(argname="argument simple_name", value=simple_name, expected_type=type_hints["simple_name"])
...
class StringListParameter(
    ...
    def from_list_parameter_attributes(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StringListParameter.from_list_parameter_attributes)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def value_for_typed_list_parameter(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StringListParameter.value_for_typed_list_parameter)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument parameter_name", value=parameter_name, expected_type=type_hints["parameter_name"])
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
...
class StringParameter(
    ...
    def value_for_typed_string_parameter_v2(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StringParameter.value_for_typed_string_parameter_v2)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument parameter_name", value=parameter_name, expected_type=type_hints["parameter_name"])
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
