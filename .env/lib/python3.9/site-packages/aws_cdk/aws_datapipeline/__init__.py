...
class CfnPipeline(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        parameter_objects: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnPipeline.ParameterObjectProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
