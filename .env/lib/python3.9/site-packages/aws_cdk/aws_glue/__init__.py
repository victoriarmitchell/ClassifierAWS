...
class CfnJob(
    ...
    def non_overridable_arguments(self, value: typing.Any) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnJob, "non_overridable_arguments").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def execution_class(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnJob, "execution_class").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnTrigger(
    ...
    def event_batching_condition(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnTrigger, "event_batching_condition").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class EventBatchingConditionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(CfnTrigger.EventBatchingConditionProperty.__init__)
...
class CfnWorkflow(
    ...
    def max_concurrent_runs(self, value: typing.Optional[jsii.Number]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CfnWorkflow, "max_concurrent_runs").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
